/*
 * Public API Surface of pacientes
 */
...
export * from './lib/consultar-paciente/consultar-paciente.component';
export * from './lib/editar-paciente/editar-paciente.component';